...
const Navbar = (props) => {
  ...
  return (
    <div className="flex justify-between items-center md:p-10 p-5  font-semibold text-lg z-10">
      <Link to="/home">
      ...
      {toggle ? (
        <AiOutlineClose
          onClick={navHandler}
          className="w-10 h-10 block md:hidden text-[#A02279]"
        />
      ) : (
        <GiHamburgerMenu
          onClick={navHandler}
      ...
      {toggle && (
        <div className="bg-[#A02279] absolute h-[30rem] w-[80%] top-20 left-0 rounded-r-xl p-10 z-10">
